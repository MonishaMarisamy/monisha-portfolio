...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#090918] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/nbvvweqb" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl inline font-bold border-b-4 border-pink-600 text-gray-300'>Contact</p>
                <p className='text-gray-300 py-4'>Submit form below or shoot me an email -mmonishamarisamy@gmail.com</p>
            </div>
